return {
  {
    ...
    config = function()
      ...
      wk.add({
        ...
        { "<leader>cl", function() require("nvim-treesitter.textobjects.swap").swap_next("@code_cell.outer") end, desc = "Swap Cell Next" },
        { "<leader>ch", function() require("nvim-treesitter.textobjects.swap").swap_previous("@code_cell.outer") end, desc = "Swap Cell Previous" },
