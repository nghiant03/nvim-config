return {
  {
    ...
    config = function()
      ...
      wk.add({
        ...
        { "<localleader>jc", ":JoveRunCell<CR>", desc = "Run Cell" },
        { "<localleader>ja", ":JoveRunAbove<CR>", desc = "Run Cell And Above" },
        { "<localleader>jA", ":JoveRunAll<CR>", desc = "Run All Cells" },
        { "<localleader>jn", ":JoveNextCell<CR>", desc = "Next Cell" },
        { "<localleader>jp", ":JovePrevCell<CR>", desc = "Prev Cell" },
        { "<localleader>ji", ":JoveInitKernel<CR>", desc = "Init Kernel" },
        { "<localleader>jI", ":JoveImportOutputs<CR>", desc = "Import Outputs" },
        { "<localleader>jE", ":JoveExportOutputs<CR>", desc = "Export Outputs" },
